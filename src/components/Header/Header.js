      ...
      <Container className='d-flex justify-content-between'>
        ...
        <Navbar.Collapse id="responsive-navbar-nav" className='justify-content-end'>
          <div className="nav-menu">
            ...
            {location.includes('/inscripcion')?<Link to='/inscripcion' className='mx-3 nav-links nav-link-active'>Inscribete</Link>:<Link to='/inscripcion' className='mx-3 nav-links'>Inscribete</Link>}
